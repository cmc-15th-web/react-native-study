...
export const PlusIcon = ({ color, fill }: IconType) => {
  return (
    <Svg width="60" height="60" viewBox="0 0 60 60" fill="none" color={color}>
      <Defs>
        <LinearGradient
          id="paint0_linear_767_318"
          x1="3.85657"
